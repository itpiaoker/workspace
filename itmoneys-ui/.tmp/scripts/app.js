...
var auth = false;
var app = angular.module('raysdata.zeta', ['ngAnimate', 'uiSwitch', 'ui.checkbox', 'ui.ace', 'ngRoute', 'ngResource', 'ui.bootstrap', 'nvd3', 'ngCookies']);
...
app.controller('HeaderController', ['$scope', 'CURRENTUSER', function ($scope, CURRENTUSER) {
