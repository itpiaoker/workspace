 ...
 * @date 2017/11/25
 */
public class ListJobs implements Job {

    Logger _log = LoggerFactory.getLogger(ListJobs.class);
...
//        TriggerKey triggerKey = jobExecutionContext.getTrigger().getKey();
    ...
    public static void main(String[] args) throws Exception{
        ...
        jobDetail.setJobClass(ListJobs.class);
...
//        GroupMatcher.triggerGroupEquals("");
        Set set = sched.getTriggerKeys(GroupMatcher.triggerGroupEquals(groupName));
