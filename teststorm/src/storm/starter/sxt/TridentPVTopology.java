...
//        System.out.println(url);
  ...
  public static void main(String[] args) {
    ...
    ZkHosts zkHosts = new ZkHosts("192.168.56.201:2181,192.168.56.202:2181,192.168.56.203:2181");
...
//	}
    ...
    StateFactory state = RedisState.transactional(new InetSocketAddress("192.168.56.203", 6379), topoName);
